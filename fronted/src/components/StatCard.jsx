export default function StatCard({value,messsage,icon,students}){    
        return(
        <div className="flex flex-col justify-center items-center  gap-3 w-full shadow-lg bg-white rounded-2xl p-5 border-slate-100 border-l-green-500 border-l-6 border-r-blue-500 border-r-6  hover:shadow-blue-500  border border-slate-200">
